...
sleep 1
wget https://github.com/forceunited/force/releases/download/v3.4.0.0/force-3.4.0.0-ubuntu-16.04.tar.xz
tar xvfJ force-3.4.0.0-ubuntu-16.04.tar.xz
rm force-3.4.0.0-ubuntu-16.04.tar.xz
mv force-3.4.0.0-ubuntu-16.04 force
cd force
strip Forced
sleep 1
echo '*** Done 1/3 ***'
